...
def parameters(yaml_name: str):
    ...
    yaml_file = os.path.join(prj_dir, 'experiments/citetrack/%s.yaml' % yaml_name)
    ...
    params.checkpoint = os.path.join(save_dir, "checkpoints/train/citetrack/%s/CiteTracker_ep%04d.pth.tar" %
